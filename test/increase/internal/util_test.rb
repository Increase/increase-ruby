...
class Increase::Test::UtilFormDataEncodingTest < Minitest::Test
  ...
  def test_file_encode
    ...
    fileinput = Increase::Internal::Type::Converter.dump(Increase::Internal::Type::FileInput, "abc")
    ...
    cases = {
      ...
      file => [file.basename.to_path, /^class Increase/],
      Increase::FilePart.new(file, filename: "d o g") => ["d%20o%20g", /^class Increase/]
    }
...
class Increase::Test::UtilFusedEnumTest < Minitest::Test
  ...
  def test_external_iteration
    iter = [1, 2, 3].to_enum
    first = iter.next
    fused = Increase::Internal::Util.fused_enum(iter, external: true)
