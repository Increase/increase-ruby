...
class Increase::Test::Resources::Simulations::CheckDepositsTest < Increase::Test::ResourceTest
  def test_adjustment
    response = @increase.simulations.check_deposits.adjustment("check_deposit_f06n9gpg7sxn8t19lfc1")
    ...
    assert_pattern do
      response => {
        ...
        deposit_adjustments: ^(Increase::Internal::Type::ArrayOf[Increase::CheckDeposit::DepositAdjustment]),
