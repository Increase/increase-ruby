...
class Increase::Test::Resources::AccountsTest < Increase::Test::ResourceTest
  def test_create_required_params
    ...
    assert_pattern do
      response => {
        ...
        loan: Increase::Account::Loan | nil,
        name: String,
        program_id: String,
  ...
  def test_retrieve
    response = @increase.accounts.retrieve("account_in71c4amph0vgo2qllky")
  ...
  def test_update
    response = @increase.accounts.update("account_in71c4amph0vgo2qllky")
  ...
  def test_balance
    response = @increase.accounts.balance("account_in71c4amph0vgo2qllky")
    ...
    assert_pattern do
      response => {
        ...
        loan: Increase::BalanceLookup::Loan | nil,
  ...
  def test_close
    response = @increase.accounts.close("account_in71c4amph0vgo2qllky")
