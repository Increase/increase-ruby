  ...
  def test_create_required_params
    ...
    assert_pattern do
      response => {
        ...
        merchant_legal_business_name: String | nil,
        merchant_name: String,
        merchant_name_prefix: String,
        merchant_postal_code: String,
        merchant_state: String,
        merchant_street_address: String | nil,
        presentment_amount: Increase::CardPushTransfer::PresentmentAmount,
        recipient_address_city: String | nil,
        recipient_address_line1: String | nil,
        recipient_address_postal_code: String | nil,
        recipient_address_state: String | nil,
        recipient_name: String,
        route: Increase::CardPushTransfer::Route,
