...
module Increase
  module Models
    ...
    class CardDisputeListResponse < Increase::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Increase::Models::CardDispute>]
      required :data, -> { Increase::Internal::Type::ArrayOf[Increase::CardDispute] }
      ...
      #
      #   @param data [Array<Increase::Models::CardDispute>] The contents of the list.
      #
