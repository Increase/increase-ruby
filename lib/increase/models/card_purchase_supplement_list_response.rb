...
module Increase
  module Models
    ...
    class CardPurchaseSupplementListResponse < Increase::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Increase::Models::CardPurchaseSupplement>]
      required :data, -> { Increase::Internal::Type::ArrayOf[Increase::CardPurchaseSupplement] }
      ...
      #
      #   @param data [Array<Increase::Models::CardPurchaseSupplement>] The contents of the list.
      #
