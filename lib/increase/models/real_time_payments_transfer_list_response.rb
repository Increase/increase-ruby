...
module Increase
  module Models
    ...
    class RealTimePaymentsTransferListResponse < Increase::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Increase::Models::RealTimePaymentsTransfer>]
      required :data, -> { Increase::Internal::Type::ArrayOf[Increase::RealTimePaymentsTransfer] }
      ...
      #
      #   @param data [Array<Increase::Models::RealTimePaymentsTransfer>] The contents of the list.
      #
