...
module Increase
  module Models
    ...
    class ACHPrenotificationListResponse < Increase::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Increase::Models::ACHPrenotification>]
      required :data, -> { Increase::Internal::Type::ArrayOf[Increase::ACHPrenotification] }
      ...
      #
      #   @param data [Array<Increase::Models::ACHPrenotification>] The contents of the list.
      #
