...
module Increase
  module Models
    ...
    class PhysicalCardProfileListResponse < Increase::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Increase::Models::PhysicalCardProfile>]
      required :data, -> { Increase::Internal::Type::ArrayOf[Increase::PhysicalCardProfile] }
      ...
      #
      #   @param data [Array<Increase::Models::PhysicalCardProfile>] The contents of the list.
      #
