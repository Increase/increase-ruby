...
module Increase
  module Models
    ...
    class InboundACHTransferListResponse < Increase::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Increase::Models::InboundACHTransfer>]
      required :data, -> { Increase::Internal::Type::ArrayOf[Increase::InboundACHTransfer] }
      ...
      #
      #   @param data [Array<Increase::Models::InboundACHTransfer>] The contents of the list.
      #
