...
module Increase
  module Models
    ...
    class DigitalCardProfileListResponse < Increase::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Increase::Models::DigitalCardProfile>]
      required :data, -> { Increase::Internal::Type::ArrayOf[Increase::DigitalCardProfile] }
      ...
      #
      #   @param data [Array<Increase::Models::DigitalCardProfile>] The contents of the list.
      #
