...
module Increase
  module Models
    ...
    class DocumentListResponse < Increase::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Increase::Models::Document>]
      required :data, -> { Increase::Internal::Type::ArrayOf[Increase::Document] }
      ...
      #
      #   @param data [Array<Increase::Models::Document>] The contents of the list.
      #
