...
module Increase
  module Models
    ...
    class BookkeepingAccountListResponse < Increase::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Increase::Models::BookkeepingAccount>]
      required :data, -> { Increase::Internal::Type::ArrayOf[Increase::BookkeepingAccount] }
      ...
      #
      #   @param data [Array<Increase::Models::BookkeepingAccount>] The contents of the list.
      #
