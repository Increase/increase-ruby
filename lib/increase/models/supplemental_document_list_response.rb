...
module Increase
  module Models
    ...
    class SupplementalDocumentListResponse < Increase::Internal::Type::BaseModel
      # @!attribute data
      #   The contents of the list.
      #
      #   @return [Array<Increase::Models::EntitySupplementalDocument>]
      required :data, -> { Increase::Internal::Type::ArrayOf[Increase::EntitySupplementalDocument] }
      ...
      #
      #   @param data [Array<Increase::Models::EntitySupplementalDocument>] The contents of the list.
      #
