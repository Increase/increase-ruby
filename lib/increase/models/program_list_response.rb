...
module Increase
  module Models
    ...
    class ProgramListResponse < Increase::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Increase::Models::Program>]
      required :data, -> { Increase::Internal::Type::ArrayOf[Increase::Program] }
      ...
      #
      #   @param data [Array<Increase::Models::Program>] The contents of the list.
      #
